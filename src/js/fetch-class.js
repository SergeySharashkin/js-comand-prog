...
export class RenderClass {
  ...
  renderFilmsMarkup = films => {
    ...
    <div><img src="https://image.tmdb.org/t/p/w500${poster_path}" alt="" width="300px" loading="lazy"/></div>
    <div>
      <h4 class="film-list__item-title">${original_title}</h4>
      <p class="film-list__item-text">${this.replaceIdsWithGenres(
        genre_ids,
      )}${data}<span class="film-list__item-rating">${vote_average}</span></p>
    </div>
  </li>
`;
      })
